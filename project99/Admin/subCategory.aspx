<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPage.master"  CodeFile="subCategory.aspx.cs" Inherits="subCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div class="main">
        ...
        <div class="cathead">
            ...
            <a href="subCategoryList.aspx">Back</a>
        </div>
        <div class="cats">
            <div class="head">Add SubCategories</div>

            <div class="input select"><p>Category</p>
    ...
    <asp:DropDownList ID="DropDownList2" runat="server" >
            ...
            <div class="input"><p>SubCategory</p>
