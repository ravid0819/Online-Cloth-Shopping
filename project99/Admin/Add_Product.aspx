...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr >
        <td class="auto-style7">
            ...
            <h3>SubCategory</h3>
            <asp:DropDownList ID="DropDownList3" runat="server" CssClass="dropdown-box" AutoPostBack="True">
                <asp:ListItem Selected="True">--Select Sub Category--</asp:ListItem>        
            </asp:DropDownList>

             <h3>Brand</h3>
             <asp:DropDownList ID="DropDownList4" runat="server" CssClass="dropdown-box" AutoPostBack="True">
