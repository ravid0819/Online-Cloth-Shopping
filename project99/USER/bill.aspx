        ...
        <div class="bill-section">
            <div class="bill-page">
                <div class="bill-heading grid1">
                    <div class="logo">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/USER/img/logo.png" />
                ...
                <div class="bill-detail grid1">
                    <div class="user-detail">
                        ...
                        <p><span runat="server" id="city"></span>
                           , <span runat="server" id="state"></span></p>
                        <p runat="server" id="pincode"></p>
                        <p >Mo.No:<span runat="server" id="number"></span></p>
                    </div>
                    <div class="pay-to">
                        <h3>Pay To:</h3>
